...
public class SockRTDAccessor {
  public static java.lang.Integer gettimeIndex(EObject eObject) {
		return (java.lang.Integer)  getAspectProperty(eObject, "fr.inria.kairos.sock.Sock", "fr.inria.kairos.sock.aspects.IotSystemAspect", "timeIndex");
	}
	public static boolean settimeIndex(EObject eObject, java.lang.Integer newValue) {
		return setAspectProperty(eObject, "fr.inria.kairos.sock.Sock", "fr.inria.kairos.sock.aspects.IotSystemAspect", "timeIndex", newValue);
	}
